...
namespace MSFootball.Models.Data
{
    ...
    public class MatchStatistic
    {
        ...
        public static MatchStatistic Empty => new MatchStatistic(null, null, null) { IsEmpty = true };

        private MatchStatistic(Statistic match, Statistic first, Statistic second)
        {
        ...
        public static MatchStatistic Build(Statistic match, Statistic first, Statistic second)
        {
            if (match != null || first != null || second != null)
                return new MatchStatistic(match, first, second);

            return new MatchStatistic(null, null, null) { IsEmpty = true };
        }
        ...
        public Statistic this[Half half]
        {
            get
            {
                switch (half)
                {
                    case Half.Match:    return statistics[0];
                    case Half.First:    return statistics[1];
                    case Half.Second:   return statistics[2];
                    default:            return null;
                }
            }
        }
        ...
        public static MatchStatistic ToObject(byte[] bytes)
        {
            ...
            //if (bytes[bytes.Length - 1] != bytes.Length) return null;
            ...
            return Build(res[0], res[1], res[2]);
        }
    ...
    public class Statistic
    {
        ...
        Dictionary<StatisticType,StatisticValue> _statistics;
